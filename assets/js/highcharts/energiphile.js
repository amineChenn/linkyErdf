...
$(function () {
    ...
    //--Start kwh
    $('.dateEndKwhPeriod').datepicker("setDate", new Date());
    $('.dateStartKwhPeriod').datepicker("setDate", yesterday);

    $('#dateStartKwh').on('changeDate', function () {
        $('.datepicker').hide();
        document.getElementById('wattPeriodCharts').style.display = "none";
        document.getElementById('spinnerPeriodKwh').style.display = "block";
        getKwhPeriod();
        getSelectedMode();
    });

    $('#dateEndKwh').on('changeDate', function () {
        $('.datepicker').hide();
        document.getElementById('wattPeriodCharts').style.display = "none";
        document.getElementById('spinnerPeriodKwh').style.display = "block";
        getKwhPeriod();
    ...
    $('#selectedMode').change(function () {
        ...
        document.getElementById('spinnerPeriodKwh').style.display = "block";
        getSelectedMode();
        document.getElementById('spinnerPeriodKwh').style.display = "none";
    ...
    //--Start Courant
    $('.dateEndCourantPeriod').datepicker("setDate", new Date());
    $('.dateStartCourantPeriod').datepicker("setDate", yesterday);

    $('#dateStartCourant').on('changeDate', function () {
        $('.datepicker').hide();
        document.getElementById('courantPeriodCharts').style.display = "none";
        document.getElementById('spinnerPeriodCourant').style.display = "block";
        getCourantPeriod();
    });

    $('#dateEndCourant').on('changeDate', function () {
        $('.datepicker').hide();
        document.getElementById('courantPeriodCharts').style.display = "none";
        document.getElementById('spinnerPeriodCourant').style.display = "block";
        getCourantPeriod();
    ...
    //--Start Tension
    $('.dateEndTensionPeriod').datepicker("setDate", new Date());
    $('.dateStartTensionPeriod').datepicker("setDate", yesterday);

    $('#dateStartTension').on('changeDate', function () {
        $('.datepicker').hide();
        document.getElementById('tensionPeriodCharts').style.display = "none";
        document.getElementById('spinnerPeriodTension').style.display = "block";
        getTensionPeriod();
    });

    $('#dateEndTension').on('changeDate', function () {
        $('.datepicker').hide();
        document.getElementById('tensionPeriodCharts').style.display = "none";
        document.getElementById('spinnerPeriodTension').style.display = "block";
        getTensionPeriod();
...
function livePower (dataBase) {
    document.getElementById('spinnerLiveKwh').style.display = "none";
    // Create the chart
...
function getKwhPeriod() {

    var dateStart = $('#dateStartKwh').datepicker("getDate");
    var dateEnd = $('#dateEndKwh').datepicker("getDate");
    if (dateEnd<dateStart) {
        document.getElementById('spinnerPeriodKwh').style.display = "none";
        document.getElementById("#errorMessageDateKwh").style.display = "block";
        $(".alert").delay(4000).slideUp(500, function() {
            document.getElementById("#errorMessageDateKwh").style.display = "none";
        });
        $('#dateEndKwh').datepicker({
            startDate: $('#dateStartKwh').datepicker("getDate")
        });
    }
    else {
        //TODO query
            ...
            $.ajax({
                ...
                success: function (data) {
                    if (data[0] !== null) {
                        ...
                        document.getElementById('spinnerPeriodKwh').style.display = "none";
                        document.getElementById("#errorEmptyDataKwh").style.display = "block";
                        $(".alert").delay(4000).slideUp(500, function () {
                            document.getElementById("#errorEmptyDataKwh").style.display = "none";
                        });
                    }
                },
                error: function () {
...
//--Start courant
function liveCourant (dataBase) {
    document.getElementById('spinnerLiveCourant').style.display = "none";
    // Create the chart
            ...
            events: {
                load: function () {
                    ...
                    setInterval(function () {
                        var liveData =  JSON.parse(getLiveData());
                        var x = new Date(liveData[0].Date).getTime(), // current time
                            y = parseInt(liveData[0].Intensite);
                        series.addPoint([x, y], true, true);
                    }, 1000);
                }
            }
...
function powerPeriod (dataBase) {
    document.getElementById('spinnerPeriodCourant').style.display = "none";
    document.getElementById('courantPeriodCharts').style.display = "block";
    // Create the chart
    //TODO init with yesterday and today
...
function getCourantPeriod() {

    var dateStart = $('#dateStartCourant').datepicker("getDate");
    var dateEnd = $('#dateEndCourant').datepicker("getDate");
    if (dateEnd<dateStart) {
        document.getElementById('spinnerPeriodCourant').style.display = "none";
        document.getElementById("#errorMessageDateCourant").style.display = "block";
        $(".alert").delay(4000).slideUp(500, function() {
            document.getElementById("#errorMessageDateCourant").style.display = "none";
        });
        $('#dateEndCourant').datepicker({
            startDate: $('#dateStartCourant').datepicker("getDate")
        });
    }
    else {
        //TODO query
            ...
            $.ajax({
                ...
                success: function (data) {
                    if (data[0] !== null) {
                        ...
                        document.getElementById('spinnerPeriodCourant').style.display = "none";
                        document.getElementById("#errorEmptyDataCourant").style.display = "block";
                        $(".alert").delay(4000).slideUp(500, function() {
                            document.getElementById("#errorEmptyDataCourant").style.display = "none";
                        });
                    }
                },
                error: function() {
...
//--Start tension
function liveTension (dataBase) {
    document.getElementById('spinnerLiveTension').style.display = "none";
    // Create the chart
...
function tensionPeriod (dataBase) {
    document.getElementById('spinnerPeriodTension').style.display = "none";
    document.getElementById('tensionPeriodCharts').style.display = "block";
    // Create the chart
    //TODO init with yesterday and today
...
function getTensionPeriod() {

    var dateStart = $('#dateStartTension').datepicker("getDate");
    var dateEnd = $('#dateEndTension').datepicker("getDate");
    if (dateEnd<dateStart) {
        document.getElementById('spinnerPeriodTension').style.display = "none";
        document.getElementById("#errorMessageDateTension").style.display = "block";
        $(".alert").delay(4000).slideUp(500, function() {
            document.getElementById("#errorMessageDateTension").style.display = "none";
        });
        $('#dateEndTension').datepicker({
            startDate: $('#dateStartTension').datepicker("getDate")
        });
    }
    else {
        //TODO query
            ...
            $.ajax({
                ...
                success: function (data) {
                    if (data[0] !== null) {
                        ...
                        document.getElementById('spinnerPeriodTension').style.display = "none";
                        document.getElementById("#errorEmptyDataTension").style.display = "block";
                        $(".alert").delay(4000).slideUp(500, function() {
                            document.getElementById("#errorEmptyDataTension").style.display = "none";
                        });
                    }
                },
                error: function() {
