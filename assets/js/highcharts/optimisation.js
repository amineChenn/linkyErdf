...
angular	.module("appOptimisation", [])
    ...
    , function($scope,$interval,$timeout,$http,$httpProvider)
    {
	    ...
	    $scope.pApparenteSouscriteAffichee =$scope.pApparenteSouscrite
            $scope.pApparenteSouscriteAnalyse = $scope.pApparenteSouscrite*1000;
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if (data.length !== 0) {
			data[0].MaxPapparente= data[0].MaxPapparente/1000
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if (data.length !== 0) {
			data[0].MoyPApparente = data[0].MoyPApparente/1000
            ...
            $.ajax({
                type: "GET",
                url: url + ":" + port + "/" + projectDirectory + "/" + api + "/NbPApparenteDepasse?date1="+$scope.dateDebut+"&date2="+$scope.dateFin+"&pApparenteMax="+$scope.pApparenteSouscriteAnalyse,
                cache: false,
                async: false,
                dataType: 'json',
                success: function (data) {
            ...
            $.ajax({
                type: "GET",
                url: url + ":" + port + "/" + projectDirectory + "/" + api + "/SelectAllPApparenteDepasse?date1="+$scope.dateDebut+"&date2="+$scope.dateFin+"&pApparenteMax="+$scope.pApparenteSouscriteAnalyse,
                cache: false,
                async: false,
                dataType: 'json',
                success: function (data) {
