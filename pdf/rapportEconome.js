angular	.module("appTarif", [])
    ...
    , function($scope,$interval,$timeout,$http,$httpProvider)
    {
        ...
        $scope.calculerFacture = function (dateDebut, dateFin){
            ...
            $.ajax({
                type: "GET",
                url: "http://localhost/projetERDF/api.php/SelectAll/tarifs",
                cache: false,
                async: false,
                dataType: 'json',
        ...
        $scope.calculerTotalFacture = function (){
            ...
            console.log("factttt",factureActuelle);
            var facturePrec = $scope.calculerFacture(dateDebutPrec, dateFinPrec);
            console.log("fact",facturePrec);
...
$(function() {
    ...
    $.ajax({
        type: "GET",
        url: "http://localhost/projetERDF/api.php/SelectYears",
        cache: false,
        async: true,
        dataType: 'json',
        success: function(data){
